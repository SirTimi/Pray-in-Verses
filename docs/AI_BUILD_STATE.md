...
Current cycle follow-up: harden the production offline exporter with staged output publication and book-slug collision checks so failed exports cannot wipe or silently overwrite a previously valid bundled dataset. Status: AWAITING USER TEST.
