...
export default function JournalScreen() {
  ...
  const showFloatingAdd = !loading && !error && hasEntries;
  const showEmptyFooter = !loading && !error && !hasEntries;
        ...
        >
          ...
          {loading ? (
            <AppStateView
              ...
              body="We’re loading your reflections and prayers."
            ...
            <View style={styles.list}>
              {visibleEntries.map((entry) => {
                ...
                return (
                  <Pressable
                    key={entry.id}
                    onPress={() => router.push({ pathname: '/(app)/journal/[id]', params: { id: entry.id } })}
...
const styles = StyleSheet.create({
  ...
  page: { flex: 1 },
  content: { paddingHorizontal: spacing.base, paddingTop: spacing.sm, paddingBottom: 120 },
