      ...
      >
        ...
        <View style={styles.statsRow}>
          ...
          <StatCard
            label="Praying"
            value={stats.open}
            icon={<Heart size={18} color="#2F6ECF" />}
          />
          <StatCard
            label="Answered"
        ...
        <View style={styles.filters}>
          ...
          <FilterButton
            label="Praying"
            active={filter === 'OPEN'}
            onPress={() => chooseFilter('OPEN')}
          />
          <FilterButton
            label="Answered"
            active={filter === 'ANSWERED'}
            onPress={() => chooseFilter('ANSWERED')}
          />
        </View>
          ...
          <AppStateView
            ...
            body={
              query
                ...
                : filter === 'ANSWERED'
                  ? 'When a prayer is answered, mark it here as a testimony.'
                  : 'Add something you want to keep bringing before God.'
            }
            actionLabel={showEmptyAdd ? 'Add Prayer' : undefined}
            onAction={showEmptyAdd ? () => openEditor('new') : undefined}
            style={styles.stateSpacing}
          />
        ) : (
                  ...
                  <Pressable onPress={() => openEditor(prayer.id)} style={styles.cardMain}>
                    <View style={styles.cardTopRow}>
                      <View
                        style={[
                          styles.statusPill,
                          answered ? styles.answeredPill : styles.openPill,
                        ]}
                      >
                        {answered ? (
                        ...
                        <Text
                          style={[
                            styles.statusText,
                            answered ? styles.answeredText : styles.openText,
                          ]}
                        >
                      ...
                      <Text style={styles.dateText}>
                        {formatRelativeDate(prayer.updatedAt || prayer.createdAt)}
                      </Text>
                    </View>

                    <View style={styles.titleRow}>
                      <Text numberOfLines={2} style={styles.prayerTitle}>
                        {prayer.title}
                      </Text>
                      <ChevronRight size={19} color={colors.primary} />
                    </View>

                    <Text numberOfLines={3} style={styles.prayerBody}>
                      {prayer.body}
                    </Text>
